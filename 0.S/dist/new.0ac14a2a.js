...
var _MusicPlayer = require("./classes/MusicPlayer");

var _Engine = require("./classes/Engine");

var _FuelTank = require("./classes/FuelTank");
...
var musicPlayer = new _MusicPlayer.MusicPlayer(0, 50);
var engine = new _Engine.Engine(false);
var fuelTank = new _FuelTank.FuelTank(defaultFuel, defaultFuelMileage, defaultFuelMaxCapacity);
var car = new _Car.Car(musicPlayer, engine, fuelTank);
